...
export default function ApplyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // STEP 3: Log everything before submit
      console.log('SUBMIT PAYLOAD:', {
        ...
        department: job?.department || '(none)',
        location: job?.location || '(none)',
        employmentType: job?.type || '(none)',
        cvFileName: file.name
      })

      // STEP 4: Send request as FormData (NOT JSON)
      ...
      if (response.ok) {
        ...
        // STEP 5: Show REAL backend error
          ...
          <form onSubmit={handleSubmit} className="space-y-8" encType="multipart/form-data">
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                ...
                {jobId && job ? (
                  /* Read-only job summary card when arriving from job details */
                  ...
                  /* Manual position selection when no jobId */
                  <div>
